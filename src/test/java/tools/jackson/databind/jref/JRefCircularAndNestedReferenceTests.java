...
public class JRefCircularAndNestedReferenceTests extends JRefAbstractTest {
    ...
    public void testSiblingAndNeighborDeserialization() throws Exception {
        ...
        // JSON representing nodes where neighbors refer back to previous nodes in a list
        String json = "{" +
                "  \"allNodes\": [" +
                "    { \"name\": \"node0\" }," +
    ...
    public void testNestedPathDeserialization() throws Exception {
        ...
        String json = "{" +
                ...
                "  }," +
                "  \"allNodes\": [" +
                "    { \"$ref\": \"#/root/neighbors/name/child/name\" }" +
                "  ]" +
                "}";
