...
module tools.jackson.databind
{
    ...
    opens tools.jackson.databind.ext.datetime;
    opens tools.jackson.databind.ext.datetime.deser;
    opens tools.jackson.databind.ext.datetime.deser.key;
    opens tools.jackson.databind.ext.datetime.key;
    opens tools.jackson.databind.ext.datetime.misc;
    opens tools.jackson.databind.ext.datetime.ser;
    opens tools.jackson.databind.ext.datetime.tofix;
    opens tools.jackson.databind.ext.datetime.util;
