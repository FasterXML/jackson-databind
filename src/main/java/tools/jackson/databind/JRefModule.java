...
public class JRefModule extends SimpleModule {
	...
	public class JRefValueDeserializerModifier extends ValueDeserializerModifier {
		...
		class JRefJsonPointer {

			JsonParser parser;
			JsonPointer pointer;
			
			JRefJsonPointer(JsonParser p, DeserializationContext ctxt) {
				this.parser = p;
				if (p.currentToken() == JsonToken.START_OBJECT) {
					...
					if (jrefValue != null) {
						...
						try {
							// compile JsonPointer
							pointer = JsonPointer.valueOf(path);
							// If empty, we throw
		...
		public class JRefValueDeserializer extends DelegatingDeserializer {
			...
			public Object deserializeWithType(JsonParser p, DeserializationContext ctxt,
				...
				JRefJsonPointer jref = new JRefJsonPointer(p, ctxt);
				if (jref.pointer != null) {
					return jref.pointer;
				} else {
					return super.deserializeWithType(jref.parser, ctxt, typeDeserializer);
				}
			}
			...
			public Object deserialize(JsonParser p, DeserializationContext ctxt) throws JacksonException {
				...
				if (jref.pointer != null) {
					...
					return super.deserialize(jref.parser, ctxt);
				}
			}
