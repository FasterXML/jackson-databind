 ...
 * {@link DatabindException}, the way cycles through bean properties are, rather than
...
public class JsonValueCycleSer6206Test extends DatabindTestUtil
{
    ...
    static class FixedSerializer extends ValueSerializer<SelfWithCustomSerializer> {
        @Override
        public void serialize(SelfWithCustomSerializer value, JsonGenerator gen, SerializationContext ctxt)
        {
