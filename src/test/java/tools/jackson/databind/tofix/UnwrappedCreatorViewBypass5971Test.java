 ...
 *
 * UnwrappedPropertyHandler.processUnwrappedCreatorProperties() iterates over
 * _creatorProperties and calls prop.deserialize() without checking
 ...
 * with @JsonUnwrapped can still be populated from untrusted JSON while reading
...
public class UnwrappedCreatorViewBypass5971Test extends DatabindTestUtil
{
    ...
    @Test
    public void testUnwrappedCreatorParamBypassesJsonView() throws Exception {
        UserBean result = MAPPER
        ...
        assertNull(result.address,
                "[databind#5971] VULNERABLE: @JsonView(AdminView) @JsonUnwrapped creator parameter " +
